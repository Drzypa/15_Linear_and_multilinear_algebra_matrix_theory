...
\usepackage{pmmeta}
\pmcanonicalname{PrincipalComponentsAnalysis}
\pmcreated{2013-03-22 12:11:49}
\pmmodified{2013-03-22 12:11:49}
\pmowner{akrowne}{2}
\pmmodifier{akrowne}{2}
\pmtitle{principal components analysis}
\pmrecord{7}{31493}
\pmprivacy{1}
\pmauthor{akrowne}{2}
\pmtype{Definition}
...
\pmsynonym{Karhunen-Loeve transform}{PrincipalComponentsAnalysis}
\pmsynonym{Hotelling transform}{PrincipalComponentsAnalysis}
\pmsynonym{PCA}{PrincipalComponentsAnalysis}
