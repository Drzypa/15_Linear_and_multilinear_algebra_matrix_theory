...
\usepackage{pmmeta}
\pmcanonicalname{LinearTransformation}
\pmcreated{2013-03-22 11:56:41}
\pmmodified{2013-03-22 11:56:41}
\pmowner{CWoo}{3771}
\pmmodifier{CWoo}{3771}
\pmtitle{linear transformation}
\pmrecord{24}{30697}
\pmprivacy{1}
\pmauthor{CWoo}{3771}
\pmtype{Definition}
...
\pmsynonym{linear map}{LinearTransformation}
\pmsynonym{vector space homomorphism}{LinearTransformation}
\pmsynonym{linear mapping}{LinearTransformation}
\pmrelated{Matrix}
...
\pmrelated{NilpotentTransformation}
\pmrelated{AffineTransformation}
\pmrelated{SubLinear}
\pmrelated{MatrixRepresentationOfALinearTransformation}
\pmdefines{linear operator}
