...
\usepackage{pmmeta}
\pmcanonicalname{Covector}
\pmcreated{2013-03-22 13:14:39}
\pmmodified{2013-03-22 13:14:39}
\pmowner{bwebste}{988}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
If $V$ is a vector space over a field $k$, then a {\em covector} is a linear map $\alpha:V\to k$, that is, and element of the dual space to $V$.  Thus, for example, a covector field on a differentiable manifold is a synonym for a \PMlinkname{1-form}{DifferentialForms}.
%%%%%
%%%%%
\end{document}
